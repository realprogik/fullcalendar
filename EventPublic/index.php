...
<html>
 <head>
  <title>Calendrier événements public (avec réservation à l'espace)</title>
    ...
    select: function(start, end, allDay)
    {
      var dialog=$("#dialog").dialog({ modal: true,width:600, buttons: {
        'Valider' : function() {
                            ...
                            url:"update2.php",
                             type:"POST",
                            data:{title:title,description:description,image:image,start:start, end:end, id:id},
                            success:function(){
 ...
 <body>
  <br />
  <h2 align="center"><a href="#"><b>Calendrier événements public (avec réservation à l'espace)</b></a></h2>
  <br />
  <div class="container">
   <div id="calendar"></div>
  </div>
